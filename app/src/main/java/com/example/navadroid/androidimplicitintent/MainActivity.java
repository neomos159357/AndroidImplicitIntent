    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.btn_intent_2:
                ...
                intent.setData(Uri.parse("tel: 0908134911" ));
                startActivity(intent);
                break;
            case R.id.btn_intent_3:
                // TODO: Open my github in browser
                intent.setAction(Intent.ACTION_VIEW);
                intent.setData(Uri.parse("https://github.com/MisterMu"));
                startActivity(intent);
                break;
            case R.id.btn_intent_4:
                // TODO: Alam Clock
                intent.setAction(AlarmClock.ACTION_SET_ALARM);
                intent.putExtra(AlarmClock.EXTRA_MESSAGE, "EIEI")
